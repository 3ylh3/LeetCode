...
/**
 * 设计一个简化版的推特(com.xiaobai.leetcood.Twitter)，可以让用户实现发送推文，关注/取消关注其他用户，能够看见关注人（包括自己）的最近十条推文。你的设计需要支持以下的几个功能：
 *
 ...
 * 示例:
 *
 * com.xiaobai.leetcood.Twitter twitter = new com.xiaobai.leetcood.Twitter();
 *
